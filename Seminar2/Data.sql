INSERT INTO ActivityType
    (Name, Factor, HpFactor, StudentFactor)
VALUES
    ('Lecture', 3.6, 1.0, 1.0),
    ('Seminar', 1.8, 1.0, 1.0),
    ('Lab', 2.4, 1.0, 1.0),
...
INSERT INTO Person
    (Name, PhoneNumber, EmailAdress, Adress, PersonalNumber)
VALUES
...
INSERT INTO Employees
    (Salary, ManagerSupervisor, DepartmentName, PersonID)
VALUES
...
INSERT INTO CourseLayout
    (Code, Name, HP, MinStudent, MaxStudent)
VALUES
...
INSERT INTO Instance
    (RegisterdStudents, Period, StudyYear, LayoutID)
VALUES
    (30, 'P1', '2024', 1),
    (25, 'P2', '2024', 2),
    (40, 'P3', '2024', 3),
...
INSERT INTO PlannedActivities
    (Type, Hours, CourseInstanceID)
VALUES
    ('Lecture', 20, 1),
    ('Lecture', 18, 1),
    ('Lab', 10, 1),
...
INSERT INTO EmployeesPlannedActivities
    (EmpoyeID, ActivityID)
VALUES
    (1, 1),
    (2, 2),
